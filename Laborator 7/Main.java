...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("The biggest area is "+FigureController.giveBiggestArea(f));
        System.out.println("The biggest perimeter is"+FigureController.giveBiggestPerimeter(f));
    }
}
